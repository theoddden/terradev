...
output "instance_id" {
  description = "Lambda Labs instance ID"
  value       = lambda_instance.gpu_node.id
}

output "public_ip" {
  description = "Public IP address"
  value       = lambda_instance.gpu_node.public_ip
}

output "private_ip" {
  description = "Private IP address"
  value       = lambda_instance.gpu_node.private_ip
}
...
output "status" {
  ...
  value = {
    instance = lambda_instance.gpu_node.state
