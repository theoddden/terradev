...
output "instance_id" {
  description = "Hyperstack instance ID"
  value       = hyperstack_instance.gpu_node.id
}

output "public_ip" {
  description = "Public IP address"
  value       = hyperstack_instance.gpu_node.public_ip
}

output "private_ip" {
  description = "Private IP address"
  value       = hyperstack_instance.gpu_node.private_ip
}
...
output "status" {
  ...
  value = {
    instance = hyperstack_instance.gpu_node.state
