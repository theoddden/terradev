#!/bin/bash
# Hyperstack GPU Node Bootstrap Script
...
echo "🚀 Bootstrapping Hyperstack GPU Node for ${CLUSTER_NAME}"
...
tailscale up --authkey="${TAILSCALE_AUTHKEY}" --hostname="${CLUSTER_NAME}-hyperstack-node" --advertise-routes=10.0.0.0/24 --accept-routes
