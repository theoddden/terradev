#!/bin/bash
# VastAI GPU Node Bootstrap Script
...
echo "🚀 Bootstrapping VastAI GPU Node for ${CLUSTER_NAME}"
...
tailscale up --authkey="${TAILSCALE_AUTHKEY}" --hostname="${CLUSTER_NAME}-vastai-node" --advertise-routes=10.0.0.0/24 --accept-routes
